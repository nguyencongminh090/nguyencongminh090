...
<p>
  <img src="https://komarev.com/ghpvc/?username=nguyencongminh090&label=Profile%20views&color=1C1917&style=flat" alt="Profile views" />
  <a href="https://orcid.org/0009-0009-6348-0359"><img src="https://img.shields.io/badge/ORCID-0009--0009--6348--0359-A6CE39?logo=orcid&logoColor=white" alt="ORCID" /></a>
</p>
...
|---|---|
| [**BasicML**](https://github.com/nguyencongminh090/BasicML) | Software architecture: I designed the OOP structure for the whole project, and built the ML from the underlying math rather than library calls. |
| [**RefereeManagerBot**](https://github.com/nguyencongminh090/RefereeManagerBot) | Automation and agent-building: Selenium-driven bots that observe live Gomoku matches on PlayOk and handle scoring and refereeing without a human in the loop. |
| [**gomoku-vn — Play3CR**](https://github.com/nguyencongminh090/gomoku-vn) | Full-stack web build (Express, Socket.IO, Vite) with custom real-time game mechanics, developed using AI-assisted workflows (Claude) alongside a Jest/Playwright test suite. |
| [**PyGomo**](https://github.com/nguyencongminh090/PyGomo) | API and library design: a Python interface over the Gomocup protocol, published on PyPI as `pygomo-lib`. |
...
- ORCID: [0009-0009-6348-0359](https://orcid.org/0009-0009-6348-0359)
